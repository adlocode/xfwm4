...
static void deiconify_view (View *view)
{
...
static void cycle_views (xfwmServer *server)
{
...
static void cycle_views_reverse (xfwmServer *server)
{
...
static bool handle_keybinding (xfwmServer *server, xkb_keysym_t sym, uint32_t modifiers)
{
	/*
		...
		struct wl_listener *listener, void *data)
{
	...
	xfwmServer *server = keyboard->server;
...
static void handle_new_keyboard (xfwmServer *server,
...
static void handle_new_pointer(xfwmServer *server, struct wlr_input_device *device)
{
...
static void new_input_notify (struct wl_listener *listener, void *data)
{
	...
	xfwmServer *server = wl_container_of(listener, server, new_input);
	switch (device->type) {
